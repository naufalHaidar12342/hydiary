...
export default async function ReadStory({ params }) {
	...
	return (
		<div className="h-full max-w-screen-xl flex flex-col justify-center items-center mx-auto px-8 text-center mt-5">
			{storyContents.map((story) => (
				<div key={story.title}>
					<h2 className="text-5xl text-lime-300 font-medium">{story.title}</h2>
