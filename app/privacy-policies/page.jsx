export const metadata = {
	...
	description: `Learn about our privacy policies ⚖️`,
};
	...
	return (
		<div className="min-h-screen max-w-(--breakpoint-md) mx-auto flex flex-col justify-center items-center px-4">
			...
			<div className="my-4" aria-label="Policies">
				<div className="mb-10">
					<p className="mt-2">
						At naufalHaidar12342, accessible from naufalhaidar12342.cyou, one of
						our main priorities is the privacy of our visitors. This Privacy
						Policy document contains types of information that is collected and
						recorded by naufalHaidar12342 and how we use it.
					</p>
				...
				<div className="mb-10">
					...
					<p className="mt-4">
						naufalHaidar12342 use &quot;Web Analytics&quot; service, provided by
						this website hosting service, Vercel. This service is used to
						collect and analyze the following information. Note that these
						information does not specify visitor as an individual.
					</p>
					<div className="ltr">
						<ul
						...
						>
							...
							<li>browser used by visitor,</li>
							<li>operating system used by visitor, and</li>
				...
				<div className="mb-10">
					...
					<p className="mt-4">
						naufalHaidar12342 follows a standard procedure of using log files.
				...
				<div className="mb-10">
					...
					<p className="mt-4">
						Like any other website, naufalHaidar12342 uses &quot;cookies&quot;.
						...
						or visited. The information is used to optimize the user experience
						by customizing our web page content based on visitor&apos;s browser
						type and/or other information.
					</p>
				</div>
				<div className="mb-10">
					<h2 className="font-bold text-lg">⚖️ Privacy Policies</h2>

					<p className="mt-4">
						You may consult this list to find the Privacy Policy for each of the
						advertising partners of naufalHaidar12342.
					</p>
					...
					<p className="mt-4">
						...
						naufalHaidar12342, which are sent directly to user&apos; browser.
					...
					<p className="mt-4">
						Note that naufalHaidar12342 has no access to or control over these
						cookies that are used by third-party advertisers.
					</p>
				</div>
				<div className="mb-10">
					<h2 className="font-bold text-lg">⚖️ Third Party Privacy Policies</h2>

					<p className="mt-4">
						naufalHaidar12342&apos;s Privacy Policy does not apply to other
				...
				<div className="mb-10">
					...
					<p className="mt-4">
						naufalHaidar12342 does not knowingly collect any Personal
				...
				<div className="mb-10">
					...
					<p>
						...
						that they shared and/or collect in naufalHaidar12342. This policy is
