		...
		<Layout pageTitle="Privacy Policy">
			<div className="min-h-screen max-w-screen-lg mx-auto">
				<div className="flex flex-col justify-center items-center">
					<h1 className="font-extrabold font-mono text-2xl mt-4">
						Privacy Policy for naufalHaidar12342
					</h1>
					<div className="my-4" aria-label="Policies">
						<div className="mb-10">
							<p className="mt-2">
								At naufalHaidar12342, accessible from naufalhaidar12342.cyou,
								one of our main priorities is the privacy of our visitors. This
								Privacy Policy document contains types of information that is
								collected and recorded by naufalHaidar12342 and how we use it.
							</p>
						...
						<div className="mb-10">
							...
							<p className="mt-4">
								naufalHaidar12342 use &quot;Web Analytics&quot; service,
								provided by this website hosting service, Vercel. This service
								is used to collect and analyze the following information. Note
								that these information does not specify visitor as an
								individual.
							</p>
							<div className="ltr">
								<ul
						...
						<div className="mb-10">
							...
							<p className="mt-4">
								...
								including visitor&apos; preferences, and the pages on the
								website that the visitor accessed or visited. The information is
								used to optimize the user experience by customizing our web page
								content based on visitor&apos;s browser type and/or other
								information.
							</p>
						</div>
						<div className="mb-10">
							<h2 className="font-bold text-lg">Privacy Policies</h2>

							<p className="mt-4">
								You may consult this list to find the Privacy Policy for each of
								the advertising partners of naufalHaidar12342.
							</p>
							...
							<p className="mt-4">
								...
								naufalHaidar12342, which are sent directly to user&apos;
							...
							<p className="mt-4">
								Note that naufalHaidar12342 has no access to or control over
						...
						<div className="mb-10">
							...
							<p>
								...
								naufalHaidar12342. This policy is not applicable to any
